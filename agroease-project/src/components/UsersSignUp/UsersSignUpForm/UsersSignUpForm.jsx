  ...
  return (
    ...
    <form onSubmit={formik.handleSubmit}>
     <h2 className='broker_signup_form_title'>Create an Account</h2>
      ...
      <small className='broker_terms'>By clicking, you agree to the AgroEase <span className='broker_green'>Term of Service</span> and acknowledge, that AgroEase <span className='broker_green'>Privacy Policy</span> applies to you</small>
