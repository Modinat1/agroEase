  ...
  useEffect(() => {
    const fetchData = async () => {
      navigator.geolocation.getCurrentPosition(function (position) {
        ...
        await fetch(` https://api.openweathermap.org/data/2.5/weather/?lat=${lat}&lon=${long}&units=metric&APPID=d065cebed8aca1c38e488d38fece74f4`
        )
        .then(res => res.json())
        .then(result => {
          setData(result)
  ...
  return (
    <div>
      ...
      <section className="buyer_weather_container">
        ...
        alt="weather pictures"    id="weather_cloud_icon"
      />
        </div>
        <p>
          Today:
